...
const { hashPassword, comparePassword, generateSessionToken } = require('../utils/crypto');
...
router.post('/register', async (req, res) => {
    try {
        ...
        const { email, password, phone, first_name, last_name, date_of_birth, country, nationality } = req.body;
        ...
        await req.supabase
            ...
            .insert({
                ...
                message: 'Your account has been created successfully. Welcome to our international banking platform.'
            });
